...
const ComicCover = ({
	...
	return (
		<div className="shadow-md border group text-white relative overflow-hidden border-border rounded-xl min-w-[210px]  ring-2 transition-colors focus:ring-primary hover:shadow-primary">
			...
			<div className="flex items-cente flex-col text-xs p-2 gap-1 bg-background-tertiary/5 left-0 right-0 w-full top-0 absolute">
			...
			<div className="p-3 bg-foreground/5 backdrop-blur-[1px] left-0 right-0 w-full bottom-0 absolute">
				<div className="">
					<h2 className="drop-shadow-md text-sm">{name}</h2>
					<h3 className="drop-shadow-md text-xs text-foreground-secondary">
						{author}
					</h3>
				</div>
			</div>
