...
const FeatureCard = () => {
	return (
		<div className="card-container grid relative rounded-xl overflow-hidden border-2 border-border bg-background-secondary/20 backdrop-blur bg-gradient-to-t from-background-secondary/40 from-10% to-transparent text-sm space-y-2 p-5 pr-10 before:absolute before:bg-gradient-to-r before:from-transparent before:to-background-secondary/40 before:from-10% before:inset-0">
